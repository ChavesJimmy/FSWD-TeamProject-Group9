...
(29, 'Applied Nutrition Digital Watch', '', 'Digital watch with the following features: stopwatch, alarm, and countdown timer. It is also 50m water-resistant.\r\nIt has a comfortable black strap and light to illuminate the digital clock.', 9, '', '', NULL, 1),
(30, 'Set of 5 Resistance Loop Bands', '', 'Resistance Exercise Bands allow you to get a complete body workout, train the legs, arms and more. Shape perfect body curve, stay fit and achieve your goal, perfect for both men and women.', 10, '', '', NULL, 1),
(31, 'MuscleAmmo BMO Print Muscle Fit T-Shirt - White', '', 'The MuscleAmmo Beast Mode On Print Muscle Fit T-Shirt is available in Black, White & Grey.\r\nIt is a comfortable yet stylish t-shirt, that is perfect for the gym or everyday wear.\r\nWith a perfect fit on the body and arms, this muscle fit t-shirt not only e', 16, '', '', NULL, 1),
(32, 'MuscleAmmo Fearless Print Muscle Fit T-Shirt - Black', '', 'MuscleAmmo Fearless Print premium T-Shirt. 100% Cotton with suede FEARLESS print.', 15, '', '', NULL, 1),
(33, 'MuscleAmmo GAINS Print Muscle Fit T-Shirt - Black', '', 'The MuscleAmmo Gains Print Muscle Fit T-Shirt is available in Black & White.\r\nIt is a comfortable yet stylish t-shirt, that is perfect for the gym or everyday wear.\r\nWith a perfect fit on the body and arms, this muscle fit t-shirt not only enhances the ph', 16, '', '', NULL, 1),
(34, 'Mens No Pain No Gain Cotton Sleeveless Vest', '', '100% cotton Cotton Hand Wash Only Sleeveless', 11, '', '', NULL, 1),
(35, 'Muscle Ammo T-Shirt - White', '', '100% Cotton Loose fit Fine gauge knit 145 gsm Shoulder to shoulder taping Rolled forward shoulders for better fit Front cover seaming on collar To fit chest', 20, '', '', NULL, 1),
(36, 'Muscle Ammo Classic Hoody - Customised - White', '', 'MuscleAmmo Classic Hoody - Customize with your name/ text 80% Cotton, 20% Polyester 280 gsm Kangaroo pouch pocket Drawcord double lined hood Warm and fashionable', 35, '', '', NULL, 1),
(37, 'Womens USN Slouch Yoga Top', '', 'A stylish design which offers fantastic comfort during your training. The USN Slouch Yoga Top features a grey and black slouch design for extra flexibility. The fashionable Slouch Yoga Top is the ideal piece of gym wear, especially those extra-stretchy yo', 5, '', '', NULL, 1);
